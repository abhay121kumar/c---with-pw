...
Output format :
For each test case, print the elements of the two-dimensional array/list in the sine wave order in a single line, separated by a single 
space.
...
// void sineWave(int input[100][100],int n,int m)
// {
//     int k=0,p=0;
//     while(k<m)
//     {
